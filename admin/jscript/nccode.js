/** Project N(:Caster:) nccode.js
  * Main function: A simple java script to insert a tag (tags) in to a forum..
  * Version: 1.1
...
if (input == 'url' || input == 'nav' || input == 'option' || input == 'quote' || input == 'email' || input == 'infile' || input == 'img' || input == 'u' || input == 'b' || input == 'i' || input == 'imageid' || input == 'include') {
	...
	if (input == 'option' && document.news.base.value != 'rb') { var name = prompt("Please enter the name of this option.", ""); var values = prompt("Please enter the value of this option.", "");}
	if (input == 'option' && document.news.base.value == 'rb') { var name = ''; var values = prompt("Please enter a value for this option, no name is needed for a radio type field.", "");}
	...
	if (input == 'option') {
	var input2 = "\n["+name+":"+values+"]";
	var old = document.news.fields.value;
	var addcode = old+input2;
	document.news.fields.value=addcode;
	}
	if(input != 'nav' && input != 'option' || input != 'include' && input != 'option') {
	var old = document.news.desc.value;
	var addcode = old+input2;
	document.news.desc.value=addcode;
	}
	return;
}
