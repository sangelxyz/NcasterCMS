...
/*
  ...
  * Main function: if the varaible is not set it print arrg 2 to screen, if not set it prints nothing.
  * Version: 1.0
...
function entity_function_isnotset($func,$parsedoptions,$code,$varname) {
global $code_entity,$Parse;
	...
	if (!$Parse->varindex[$parsedoptions[0]]) {
