<?php
/*
  * N(:Caster:) Entity Engine Plugin: rot13 string function
...
function entity_function_rot13str($func,$parsedoptions,$code,$varname) {
	global $Parse;
	...
	$Parse->entity_setvar($varname,preg_replace("/([a-z]{1})/ie", "entity_function_rot13_encode('\\1')", $parsedoptions[0]));	
	return;
	}
